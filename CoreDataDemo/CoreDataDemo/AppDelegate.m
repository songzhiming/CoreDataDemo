...
- (void)insertCoreData
{
    ...
    NSManagedObject *contactInfo = [NSEntityDescription insertNewObjectForEntityForName:@"ContackInfo" inManagedObjectContext:context];
    ...
    NSManagedObject *contactDetailInfo = [NSEntityDescription insertNewObjectForEntityForName:@"ContackInfoOther" inManagedObjectContext:context];
...
- (void)dataFetchRequest
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"ContackInfo" inManagedObjectContext:context];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "witmob.CoreDataDemo" in the application's documents directory.
